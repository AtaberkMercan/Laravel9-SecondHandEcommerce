...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.user_order',['datalist'=>$datalist,'setting'=>$setting]);
    }
    ...
    {
        $setting=Setting::first();
        $orderlist=Shopcart::where('user_id',Auth::id())->get();
        $total=$request->input('total');
        return view('home.user_order_create',['total'=>$total,'orderlist'=>$orderlist,'setting'=>$setting]);
    }
    ...
    public function show(Order $order,$id)
    {
        ...
        $setting=Setting::first();
        return view('home.user_order_item',['datalist'=>$datalist,'setting'=>$setting]);
    }
