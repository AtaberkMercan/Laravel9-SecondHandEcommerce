...
@section('title','Product Details | '.$setting->title)
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{\Illuminate\Support\Facades\Storage::url($data->img)}}" alt="Image">
                        </div>
                        @foreach($images as $rs)
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="{{\Illuminate\Support\Facades\Storage::url($rs->img)}}" alt="Image">
                        </div>
                        @endforeach
                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="media mb-4">
                                    <div class="media-body">
                                        ...
                                        <div class="text-primary mb-2">
                                            <i class="fas fa-star @if ($rs->rate<1)  fa fa-star-half-alt @endif"></i>
                                            <i class="fas fa-star @if ($rs->rate<2)  fa fa-star-half-alt @endif"></i>
                                            <i class="fas fa-star @if ($rs->rate<3)  fa fa-star-half-alt @endif"></i>
                                            <i class="fas fa-star @if ($rs->rate<4)  fa fa-star-half-alt @endif"></i>
                                            <i class="fas fa-star @if ($rs->rate<5)  fa fa-star-half-alt @endif"></i>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="{{route('storecomment')}}" method="post">
                                    @csrf
                                    <input type="hidden" class="input-group" id="product_id" name="product_id" value="{{$data->id}}" />
                                    <div class="form-group" >
                                        <label for="message">Subject</label>
                                        <textarea id="subject" name="subject" cols="30" rows="5" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group" >
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="card product-item border-0">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="{{\Illuminate\Support\Facades\Storage::url($rs->img)}}" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{$rs->title}}</h6>
                            <div class="d-flex justify-content-center">
                                <h6>{{$rs->price}}$</h6><h6 class="text-muted ml-2"><del>{{$rs->price*1.8}}$</del></h6>
                            </div>
                        </div>
